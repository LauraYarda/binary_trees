...
/**
 * find_node - It finds the node with a given value in a binary search tree.
...
/**
 * replace_with_successor - It replaces a node with its inorder \
 * successor in a binary search tree.
 * @node: The pointer to the node in the binary search tree.
 *
 * Return: The pointer to the node's inorder successor node.
 */
...
/**
 * bst_remove - It removes the node with a given value in a binary search tree.
 * @root: The binary search tree.
 * @value: The value of the node.
 *
 * Return: The pointer to the tree's root node, otherwise NULL.
 */
